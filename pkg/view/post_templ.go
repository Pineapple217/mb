...
func postBase(post database.Post, q *database.Queries, selected bool) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg\view\post.templ`, Line: 19, Col: 69}
		}
		...
		if post.Tags.Valid {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg\view\post.templ`, Line: 29, Col: 69}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg\view\post.templ`, Line: 31, Col: 7}
		}
...
func Nav(page int, maxPage int, query string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if page != 0 {
			...
			var templ_7745c5c3_Var17 templ.SafeURL = templ.URL("/?page=0" + query)
			...
			var templ_7745c5c3_Var18 templ.SafeURL = templ.URL("/?page=" + strconv.Itoa(page-1) + query)
		...
		if page != maxPage {
			...
			var templ_7745c5c3_Var20 templ.SafeURL = templ.URL("/?page=" + strconv.Itoa(maxPage) + query)
